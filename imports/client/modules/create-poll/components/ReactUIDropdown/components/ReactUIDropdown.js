...
export default class ReactUIDropdown extends Component {
    ...
    handleMovieNameChange(movieName) {
        ...
        var resp = Meteor.call('polls.getFood', movieName);
        console.log(resp);
    ...
    render() {
            ...
            return ( <
                    ...
                    onClick = {
                        this.handleSelectorClick.bind(this)
                    } > {
                        items.keys.selected.map(itemKey =>
                            ...
                            onClick = {
                                this.handleSelectedItemClick.bind(this, itemKey)
                            }
                            />)}
                            ...
                            focusedItem = {
                                ...
                                items.keys.displayed.map(itemKey =>
                                    ...
                                    onClick = {
                                        this.handleItemClick.bind(this, itemKey)
                                    }
                                    onHover = {
                                        this.handleItemHover.bind(this, itemKey)
                                    }
                                    />)} <
                                    /Items> <
                                    /div>
