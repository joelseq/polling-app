...
import PopOver from '../../create-poll/components/PopOver.js'
import {
  Grid,
  Button,
  FormGroup,
...
class CreateMoviePoll extends Component {
  ...
  // handles when a movie is selected from the dropdown
  ...
  render() {
    ...
    return (
      <Grid>
        <h1 className="text-center">Create a Movie Poll</h1>
        <Well>
          <Row>
          <Col md={6}>
          ...
          <Col md={6}>
              <Row>
                <Col md={12}>
                  <ControlLabel>Movies:</ControlLabel>
...
CreateMoviePoll.propTypes = {
  router: routerShape,
};

export default withRouter(CreateMoviePoll);
